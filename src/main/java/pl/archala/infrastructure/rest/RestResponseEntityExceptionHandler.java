package pl.archala.infrastructure.rest;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        var errorResponse = ErrorResponse.of(reasons, HttpStatus.BAD_REQUEST);
    ...
    private ResponseEntity<ErrorResponse> getErrorResponse(Exception e, HttpStatus status) {
        var errorResponse = ErrorResponse.of(List.of(e.getMessage()), HttpStatus.BAD_REQUEST);
        return new ResponseEntity<>(errorResponse, errorResponse.status());
    }
}